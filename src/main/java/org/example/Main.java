...
import org.example.funciones.FuncionApp;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ArticuloInsumo articuloInsumo = ArticuloInsumo.builder()
                    .denominacion("Manzana").codigo(Long.toString(new Date().getTime()) + "-" + Math.random())
                    .precioCompra(1.5)
                    .precioVenta(5d)
                    .stockActual(100)
                    .stockMaximo(200)
            ...
            ArticuloInsumo articuloInsumoPera = ArticuloInsumo.builder()
                    .denominacion("Pera").codigo(Long.toString(new Date().getTime()) + "-" + Math.random())
                    .precioCompra(2.5)
                    .precioVenta(10d)
                    .stockActual(130)
                    .stockMaximo(200)
            ...
            ArticuloManufacturado articuloManufacturado = ArticuloManufacturado.builder()
                    ...
                    .codigo(Long.toString(new Date().getTime()) + "-" + Math.random())
                    .precioVenta(150d)
